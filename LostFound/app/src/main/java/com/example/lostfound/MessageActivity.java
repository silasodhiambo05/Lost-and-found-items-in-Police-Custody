...
import com.example.lostfound.MessageAdapter;
import com.example.lostfound.GMailSender;
import com.example.lostfound.Message;
import com.example.lostfound.User;
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    sender.sendMail("New message", "You have received a new message from someone.","silasodhiambo05@gmail.com",email);
                }
                catch (Exception e) {
